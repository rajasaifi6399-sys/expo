...
// Constructing an Asset using its ID rather than its contentUri is dictated by the fact
// that the ContentResolver query returns an ID, and the contentUri must be constructed manually
